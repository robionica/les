...
//
// Implements packet_matrix.hpp interface.

#include <les/packed_matrix.hpp>

// Converts CoinPackedVector for coin-or library to PackedVector.
static void
...
PackedVector* PackedMatrix::get_vector(int i) const
{
  if (i > get_num_rows()) {
    return NULL;
  }
...
vector<int>* PackedMatrix::get_nonzero_rows() const
{
...
vector<int>* PackedMatrix::get_nonzero_cols() const
{
